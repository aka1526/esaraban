...
{    protected  $paginate =20;
    ...
    public function index(){
        $dataset=Position::where('uuid','!=','')
        ->Orderby('name')
        ->paginate(10);

        return view('position.index',compact('dataset') );
    }
    ...
    public function save(Request $request){
      ...
      $act=  Position::insert([
        ...
        return redirect('/position')->with('msg', $act);
    ...
    public function update(Request $request) {
      ...
      $act=false;
      $act=  Position::where('uuid','=',$uuid)->update([
            'name'=>$name
            , 'updated_at'=>$updated_at
            , 'updated_by'=>$updated_by
        ]);
    ...
    public function delete(Request $request) {
        ...
        $act=false;
        if($Position){
            $act= Position::where('uuid','=',$uuid)->delete();
        }
