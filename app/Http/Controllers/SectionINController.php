...
class SectionINController extends Controller
{    protected  $paginate =20;
     protected  $sectype ="IN";
    public function index(){
        ...
        return view('section.internal.index',compact('dataset') );
    }

    function add(Request $request){
        return view('section.internal.add');
    }
    ...
    public function edit(Request $request,$uuid) {
        ...
        return view('section.internal.edit',compact('data'));
    }
