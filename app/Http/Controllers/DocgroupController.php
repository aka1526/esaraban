...
{    protected  $paginate =20;
    ...
    public function index(){
        $dataset=Docgroup::where('uuid','!=','')
        ->Orderby('name')
        ->paginate(10);

        return view('docgroup.index',compact('dataset') );
    }

    function add(Request $request){
        return view('docgroup.add');
    }
    ...
    public function save(Request $request){
      ...
      $act=  Docgroup::insert([
        ...
        return redirect('/docgroup')->with('msg', $act);
    ...
    public function edit(Request $request,$uuid) {
        ...
        $data=  Docgroup::where('uuid','=',$uuid)->first();

        return view('docgroup.edit',compact('data'));
    }
    ...
    public function update(Request $request) {
      ...
      $act=false;
      $act=  Docgroup::where('uuid','=',$uuid)->update([
            'name'=>$name
            , 'updated_at'=>$updated_at
            , 'updated_by'=>$updated_by
        ]);
    ...
    public function delete(Request $request) {
        ...
        $Docgroup=  Docgroup::where('uuid','=',$uuid)->first();
        $act=false;
        if($Docgroup){
            $act= Docgroup::where('uuid','=',$uuid)->delete();
        }
