        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form id="frmadd"  name="frmadd" action="{{ route('sec-in.update') }}" method="post">
                            <input type="hidden"  id="uuid" name="uuid"  value="{{ $data->uuid }}"  >
                        @csrf

                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    <label >ชื่อหน่วยงานภายใน</label>
                            ...
                            <div class="form-group">
                                <a href="{{route('sec-in.index')}}"    class="btn  btn-warning btn-sm"><i class="fa fa-arrow-left"></i> กลับ</a>
