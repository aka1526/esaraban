        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form id="frmadd"  name="frmadd" action="{{ route('sec-ex.update') }}" method="post">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                <a href="{{route('sec-ex.index')}}"    class="btn  btn-warning btn-sm"><i class="fa fa-arrow-left"></i> กลับ</a>
