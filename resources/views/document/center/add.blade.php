                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 form-group">
                                    <label >โครงการ</label>
                                    <input type="text"  id="doc_project" name="doc_project" class="form-control" value=""  placeholder=""  >
                                </div>
                            ...
                            <div class="form-group">
                                <a href="{{route('doccenter.index')}}"    class="btn  btn-warning btn-sm"><i class="fa fa-arrow-left"></i> กลับ</a>
