    ...
    <div class="page-content fade-ex-up">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">ข้อมูลทะเบียนส่งเอกสาร</div>
                        <div class="ibox-tools">
                            <button type="button" onclick="location.href='{{ route('docsend.add') }}';"
                    ...
                    <div class="ibox-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="frmsearch" name="frmsearch" action="{{ route('docsend.index') }}" method="post">
                                    @csrf
                                  <div class="row">
